...
const dualPanRidge: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [{ id: "ridge-LR", a: { x: 200, y: 100, h: 6.2 }, b: { x: 200, y: 220, h: 6.2 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
...
const multiPanLShaped: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [] /* Coplanar flat sections have seams, not a physical ridge. */,
    traits: [{"id":"fixture-seam-0","a":{"x":380,"y":200,"h":5.4},"b":{"x":380,"y":320,"h":5.4}},{"id":"fixture-seam-1","a":{"x":200,"y":200,"h":5.4},"b":{"x":380,"y":200,"h":5.4}},{ id: "trait-c-valley", a: { x: 260, y: 120, h: 5.4 }, b: { x: 340, y: 160, h: 5.4 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
...
const tenseSmallDualPan: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [{ id: "ridge-t", a: { x: 630, y: 600, h: 5.35 }, b: { x: 630, y: 630, h: 5.35 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
...
const simpleGableClean: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [{ id: "ridge-principal", a: { x: 220, y: 120, h: 6.1 }, b: { x: 220, y: 260, h: 6.1 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
...
const gableWithChimney: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [{ id: "ridge-gc", a: { x: 220, y: 120, h: 6.1 }, b: { x: 220, y: 260, h: 6.1 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
...
const partialDegradedLike: Runtime3DFixtureBundle = {
  ...
  runtime: {
    traits: [{"id":"fixture-seam-0","a":{"x":200,"y":80,"h":5.1},"b":{"x":200,"y":200,"h":5.1}}],
    roof: {
      ...roofBase(3),
      roofPans: [
        {
...
const denseLoadedCase: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [] /* Coplanar flat sections have seams, not a physical ridge. */,
    traits: [{"id":"fixture-seam-0","a":{"x":620,"y":400,"h":5.35},"b":{"x":620,"y":560,"h":5.35}},{"id":"fixture-seam-1","a":{"x":520,"y":400,"h":5.35},"b":{"x":720,"y":400,"h":5.35}},{ id: "trait-d", a: { x: 520, y: 320, h: 5.35 }, b: { x: 720, y: 320, h: 5.35 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
...
const visualQaSimpleHouse: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [{ id: "qa-simple-ridge", a: { x: 260, y: 120, h: 6.15 }, b: { x: 260, y: 300, h: 6.15 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
...
const visualQaPremiumComplex: Runtime3DFixtureBundle = {
  ...
  runtime: {
    ...
    ridges: [] /* Coplanar flat sections have seams, not a physical ridge. */,
    traits: [{"id":"fixture-seam-0","a":{"x":460,"y":340,"h":5.35},"b":{"x":460,"y":520,"h":5.35}},{"id":"fixture-seam-1","a":{"x":340,"y":340,"h":5.35},"b":{"x":580,"y":340,"h":5.35}},{ id: "qa-valley", a: { x: 380, y: 300, h: 5.35 }, b: { x: 520, y: 380, h: 5.35 } }],
    contours: [
      {
        roofRole: "contour",
        points: [
    ...
    roofExtensions: [
      {
        ...
        ridge: {
          a: { x: 565, y: 465, h: 5.35 },
          b: { x: 565, y: 395, h: 5.35 },
        },
        hips: {
          left: { a: { x: 520, y: 385, h: 5.35 }, b: { x: 590, y: 425, h: 5.35 } },
          right: { a: { x: 610, y: 385, h: 5.35 }, b: { x: 590, y: 425, h: 5.35 } },
        },
        apexVertex: { id: "qa-dormer-1:apex", x: 590, y: 425, h: 5.35 },
