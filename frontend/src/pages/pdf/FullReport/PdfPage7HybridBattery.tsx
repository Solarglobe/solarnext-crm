          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "3.1mm" }}>
            ...
            <div style={{ ...CARD_HIGHLIGHT, flex: "0 0 auto" }}>
              ...
              {comparison.autonomy_gain_ratio != null && (
                ...
                >
                  <span>Gain d'autonomie vs sans batterie</span>
                  <span>{fmtPtsFromRatio(comparison.autonomy_gain_ratio)}</span>
                </div>
              )}
            </div>

            {/* Pourquoi les deux ? */}
            <div style={{ ...CARD_SOFT_BASE, flex: 1 }}>
              <div style={{ fontWeight: 700, marginBottom: "1.5mm", fontSize: "3.2mm", color: brandHex }}>
                Pourquoi les deux ?
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "1.8mm" }}>
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "2.65mm", color: "#444", marginTop: "0.4mm", lineHeight: 1.35 }}>
                      Stockage instantané. Charge en journée, décharge le soir. Efficacité maximale sur les pics quotidiens.
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "2.65mm", color: "#444", marginTop: "0.4mm", lineHeight: 1.35 }}>
                      Récupère le surplus de printemps/été. Crédits utilisés en automne/hiver. Aucune limite de capacité physique.
                    </div>
                  </div>
                </div>
              </div>
              ...
              {limits.length > 0 && (
                <div style={{ marginTop: "2mm" }}>
                  <div style={{ fontSize: "2.6mm", color: "#888", fontStyle: "italic", marginBottom: "0.8mm" }}>À noter :</div>
                  <ul style={{ margin: 0, paddingLeft: "3.5mm", fontSize: "2.65mm", color: "#666", lineHeight: 1.38 }}>
                    {limits.map((item) => (
                      <li key={item} style={{ marginBottom: "0.6mm" }}>{item}</li>
                    ))}
                  </ul>
                </div>
              )}
