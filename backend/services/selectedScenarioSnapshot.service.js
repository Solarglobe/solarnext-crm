...
export async function buildSelectedScenarioSnapshot({
  ...
  await assertStudyCalculationCurrent({ studyId, versionId, organizationId, data: dataJson });
  ...
  return {
    ...
    input_fingerprint: dataJson.calculation_trace?.input_fingerprint ?? null,
    calculation_trace: dataJson.calculation_trace ?? null,
