 ...
 */
import { URBAN_SOLAR_VIRTUAL_BATTERY_TARIFFS_2026_08_01 as URBAN } from "../../shared/urbanSolarVirtualBatteryTariffs2026.js";
...
function publishedSupply(common) {
  ...
  const rates = isUrban ? URBAN : MYLIGHT_ELECTRICITY_SUPPLY_2026_08_01;
  ...
  return {
    ...
    provenance: {
      ...
      source_url: isUrban ? "https://www.urbansolarenergy.fr/" : rates.sourceUrl,
...
export function resolveVirtualElectricityContract({
  ...
  const supplyRow = row ?? directSupply;
  const common = {
