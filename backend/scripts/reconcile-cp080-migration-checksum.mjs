 ...
 * backend/migrations/1776500000000_cp080_org_quote_finance_settings.js
 *
 * Audit seul :
 *   node scripts/reconcile-cp080-migration-checksum.mjs
 *
...
const MIGRATION_NAME = "1776500000000_cp080_org_quote_finance_settings";
...
async function main() {
  ...
  if (String(process.env.MIGRATION_RECONCILE_CP080 || "").trim() !== "1") {
    console.warn(
