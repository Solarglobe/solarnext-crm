...
/** Lazy pour éviter TDZ. Browser: pas de require → window.__SHADING_SOLAR_POSITION__. Node: require("./solarPosition"). */
function getComputeSunPosition() {
  if (typeof require === "function" && typeof module !== "undefined") {
    var m = require("./solarPosition");
...
/** Browser: window.__SHADING_HORIZON_MASK_SAMPLER__. Node: require("./horizonMaskSampler"). */
var _horizonMaskSampler = (function () {
  if (typeof require === "function" && typeof module !== "undefined") {
    return require("./horizonMaskSampler");
  }
