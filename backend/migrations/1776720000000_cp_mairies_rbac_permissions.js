/**
 * CP-MAIRIES-002 — Permissions RBAC module Mairies / portails DP.
 * Idempotent : INSERT … ON CONFLICT, rattachement aux rôles système.
 */

export const shorthands = undefined;

const PERMISSIONS = [
  ["mairie.read", "mairies", "Consulter les mairies et portails DP (liste, détail)"],
  ["mairie.manage", "mairies", "Créer, modifier et supprimer les fiches mairies / portails DP"],
];

/** @type {Record<string, string[]>} */
const ROLE_PERM_MAP = {
  SUPER_ADMIN: ["mairie.read", "mairie.manage"],
  ADMIN: ["mairie.read", "mairie.manage"],
  SALES_MANAGER: ["mairie.read", "mairie.manage"],
  SALES: ["mairie.read", "mairie.manage"],
  TECHNICIEN: ["mairie.read"],
  ASSISTANTE: ["mairie.read", "mairie.manage"],
  APPORTEUR: [],
};
