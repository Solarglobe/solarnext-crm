...
const UNIT_TEST_FILES = [
  'tests/mailSentIdentity.test.mjs',
  'tests/mailHealthOverview.test.mjs',
  'tests/mailSyncAccountOutcome.test.mjs',
  'tests/mailSyncFolderCursors.test.mjs',
  'tests/mailSyncCursorWriters.test.js',
  'tests/mailSyncOutcome.test.mjs',
  'tests/mailImapFlagNamespace.test.js',
  'tests/mailImapMoveNamespace.test.js',
  'tests/invoiceFinancialBalance.test.mjs',
  'tests/invoicePreparedBilling.test.mjs',
  'tests/invoicePaymentBalance.test.mjs',
  'tests/invoicePaymentConcurrency.test.mjs',
  'tests/missionTimeTenantIsolation.test.mjs',
  'tests/mailDraftAuthorization.test.mjs',
  'tests/mailDraftAccessConcurrency.test.mjs',
  'tests/mailDraftAccountFence.test.mjs',
  'tests/mailDraftRemoteReference.test.mjs',
  'tests/mailDraftRemoteImport.test.js',
  ...
  'tests/mailAttachmentDelivery.test.js',
  'tests/consuel.test.mjs',
  'tests/consuel-electrical.test.mjs',
  'tests/consuel-artifacts.test.mjs',
  'tests/consuel-technical.test.mjs',
  'tests/consuel-workflow.test.mjs',
  'tests/consuel-architecture.test.mjs',
  'tests/consuel-storage.test.mjs',
  'tests/consuel-complement.test.mjs',
  'tests/consuel-site.test.mjs',
  'tests/consuel-backup.test.mjs',
  'tests/consuel-additional-source.test.mjs',
  'tests/consuel-off-grid.test.mjs',
  'tests/deploymentEnvSafety.test.mjs',
  'tests/enedisDataConnect2026.test.mjs',
  'tests/enedisHttp2026.test.mjs',
  ...
  'tests/installer-vat.test.mjs',
  'tests/leadRequestAccessRules.test.js',
  'tests/leadScoringInactivity.test.js',
  'tests/mailAccess.service.test.js',
  'tests/mailAccountDeletion.test.js',
  'tests/mailAccountState.test.js',
  'tests/mailMicrosoftOAuth.test.js',
  'tests/mailFolderDiscovery.test.js',
  'tests/mailFolderMapping.test.js',
  'tests/mailFlagMutationBackoff.test.js',
  'tests/mailImapFlagsProvider.test.js',
  'tests/mailImapMoveProvider.test.js',
  'tests/mailLiveImap.optional.test.js',
  'tests/mailMoveMutationService.test.js',
  'tests/mailNetworkGuard.test.js',
  'tests/mailOutboxBackoff.test.js',
  'tests/mailPhase4BSourceAudit.test.js',
  'tests/mailPhase5SourceAudit.test.js',
  'tests/mailPhase6Core.test.js',
  'tests/mailPhase6BProviders.test.js',
  'tests/mailPhase6CAttachments.test.js',
  'tests/mailPhase7Security.test.js',
  'tests/mailPhase7BAntivirus.test.js',
  'tests/mailPhase6SourceAudit.test.js',
  'tests/mailRemoteIdentity.test.js',
  'tests/mailRemoteMoveReconciliation.test.js',
  'tests/mailSyncJsonbSerialization.test.mjs',
  'tests/mailWorkerStateGuards.test.js',
